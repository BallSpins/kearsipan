<x-layouts.app>
    ...
    <div class="bg-[#29627C] shadow-xl items-center justify-center rounded-xl h-160 w-370 mt-10 ml-87 p-12">
        <h1 class="text-4xl font-semibold mb-4 text-white">Buat Surat Masuk</h1>
        ...
        <form action="{{ route('tu.incoming') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex flex-row gap-40">
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <label for="file" class="w-full">
                            <div
                                class="relative border border-black border-dashed rounded-lg w-full h-20 flex items-center justify-center bg-white hover:bg-gray-50 cursor-pointer transition">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="origin_number" class="bg-white rounded border w-150 h-10 p-2 mb-2">

                    <label for="" class="text-white mb-2 text-xl">Perihal</label>
                    <textarea name="subject" id="" cols="30" rows="10"
                        class="bg-white border w-150 rounded p-2 resize-none"></textarea>
                    <div class="ml-auto">
                        <button type="submit"
