<x-layouts.app>
    ...
    <x-layouts.sidebar>
        ...
        <a href="{{ route('tu.request.list.view') }}" class="flex px-4 py-2 rounded {{ request()->routeIs('tu.request.list.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
            <div class="justify-center flex items-center">
        ...
        <a href="{{ route('tu.incoming.view') }}" class="flex px-4 py-2 rounded {{ request()->routeIs('tu.incoming.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
            <div class="justify-center flex items-center">
        ...
        <a href="{{ route('tu.archived') }}" class="flex px-4 py-2rounded {{ request()->routeIs('tu.archived') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
            <div class="justify-center flex items-center">
    ...
    <div class="flex justify-end">
        <a href="{{ route('tu.incoming.draft.create.view') }}" class="mr-20 py-4 px-10 bg-[#1D546D] text-white rounded-sm mt-5 flex items-center gap-2">
