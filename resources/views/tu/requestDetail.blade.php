<x-layouts.app>
    ...
    <x-layouts.sidebar>
        ...
        <a href="{{ route('tu.archived') }}"
            class="flex px-4 py-2rounded {{ request()->routeIs('tu.archived') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
            <div class="justify-center flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24">
                    <path fill="currentColor"
        ...
        <a href="{{ route('logout') }}" class="flex bg-[#FF0000] w-40 h-10 p-4 ml-10 mt-130 px-8">
            <div class="justify-center flex items-center">
