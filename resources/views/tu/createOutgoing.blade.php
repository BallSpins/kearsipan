...
<x-layouts.app>
    ...
    <div class="bg-[#29627C] shadow-xl items-center justify-center rounded-xl h-180 w-370 mt-10 ml-87 p-12">
        <h1 class="text-white text-4xl font-semibold mb-4">Buat Surat Keluar</h1>
        <div class=" w-full border border-gray-300 mb-15"></div>
        <form action="{{ route('tu.outgoing', $letterRequest->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="flex flex-row gap-40">
                <div class="flex flex-col">
                    ...
                    <select 
                        ...
                        class="rounded w-150 h-10 p-2 mb-2 bg-white focus:outline-none focus:ring-2 focus:ring-[#7E95DB]"
                        required
                    >
                    ...
                    <input type="text" name="address" class="bg-white rounded w-150 h-10 p-2 mb-2">
                    ...
                    <div class="flex flex-row gap-4">
                        ...
                        <label for="draft_file" class="w-full">
                            <div class="relative rounded-lg w-full h-20 flex items-center justify-center bg-white hover:bg-gray-50 cursor-pointer transition">
                                <input accept=".pdf" type="file" name="draft_file" id="draft_file" class="hidden" onchange="updateFileName(this, 'draft-name')">
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="subject" id="" cols="30" rows="10" class="bg-white w-150 rounded p-2 resize-none"></textarea>
