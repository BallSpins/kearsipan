<x-layouts.sidebar>
    <a href="{{ route('tu.dashboard') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('tu.dashboard') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
    ...
    <a href="{{ route('tu.request.list.view') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('tu.request.list.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
    ...
    <a href="{{ route('tu.archived') }}" class="flex px-4 py-2 p-3 {{ request()->routeIs('tu.archived') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
    ...
    @endif
    @if (auth()->user()->role === App\Enums\UserRole::KEPALA_TU)
        <a href="{{ route('users.index') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('users.index') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
