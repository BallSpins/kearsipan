<x-layouts.sidebar>
    <a href="{{ route('waka.dashboard') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('waka.dashboard') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
    ...
    <a href="{{ route('waka.request.view') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('waka.request.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
    ...
    <a href="{{ route('waka.review.index.view') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('waka.review.index.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
    ...
    <a href="{{ route('waka.incoming.view') }}" class="flex px-4 py-2 p-3 {{ request()->routeIs('waka.incoming.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
            ...
            <h-1 class="text-xl">Surat Masuk</h-1>
        </div>
    </a>
    <button type="button" 
