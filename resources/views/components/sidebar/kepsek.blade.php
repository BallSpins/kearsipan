<x-layouts.sidebar>
    <a href="{{ route('kepsek.dashboardkep.view') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('kepsek.dashboardkep.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
    ...
    <a href="{{ route('kepsek.outgoing.sign.view') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('kepsek.outgoing.sign.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
    ...
    <a href="{{ route('kepsek.incoming.view') }}" class="flex px-4 py-2 p-4 {{ request()->routeIs('kepsek.incoming.view') ? 'bg-[#5F9598] ' : 'hover:bg-[#5F9598]' }}">
        <div class="justify-center flex items-center">
    ...
    <button type="button" 
        ...
        class="flex bg-[#FF0000] w-40 h-10 rounded ml-10 mt-150 px-8 cursor-pointer">
