<x-layouts.app>
    ...
    <div>
        ...
        <div class="mt-20 ml-75 flex gap-15">
            ...
            <div class="bg-white rounded-xl shadow-xl w-110 h-55">
                <h1 class="font-semibold text-2xl p-2 ml-10">Surat Masuk</h1>
                <div class="flex gap-40 mt-10">
            ...
            <table class="w-full text-left">
                <thead class="bg-[#061E29]">
                    <tr>
                        ...
                        <th class="px-6 py-4 font-bold text-white text-md">Nomor Surat</th>
                        <th class="px-6 py-4 font-bold text-white text-md">Jenis Surat</th>
                        <th class="px-6 py-4 font-bold text-white text-md">Alamat</th>
                        <th class="px-6 py-4 font-bold text-white text-md text-center">Status</th>
                        <th class="px-6 py-4 font-bold text-white text-md text-center">Aksi</th>
                    </tr>
                </thead>
