        ...
        <div class="w-full bg-white p-12 max-w-lg rounded-2xl shadow-xl">
            ...
            <form action="{{ route('login') }}" method="POST" class="">
                ...
                <label for="" class="block font-semibold mb-1 text-2xl">
                    Username
                    <br>
                    <input type="text" name="username" required class="border rounded w-full mt-3">
                </label>
                <label for="" class="block font-semibold mb-1 text-2xl w-full">
                    Password
                <input type="password" name="password" required class="border rounded w-full mt-3">
                </label>
                <button type="submit"
                class="w-full h-8 bg-[#3B82F6] text-white rounded-sm mt-4"
                >Login</button>
            </form>
        </div>
    </div>
